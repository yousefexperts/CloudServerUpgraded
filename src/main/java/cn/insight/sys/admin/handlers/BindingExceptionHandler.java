package cn.insight.sys.admin.handlers;
...
public class BindingExceptionHandler {
    ...
    @Around("execution(cn.jbone.common.ui.result.Result cn.jbone.sys.admin.controller.*.*(..))")
    public Result doAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            if(throwable instanceof JboneException){
                ...
                return ResultUtils.wrapFail("wrapFail！");
            }
        }
        return result;
    }
